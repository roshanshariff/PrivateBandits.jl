...
\begin{align*}
    &\rho_{\min}\defeq  \tilde L^2 \paren*{\sqrt{mk}
                             - \paren*{\sqrt{d} + \sqrt{2\ln(\tfrac{8n}{\alpha})}}}^2,
    &\rho_{\max}\defeq \tilde L^2 \paren*{\sqrt{mk}
                             + \paren*{\sqrt{d} + \sqrt{2\ln(\tfrac{8n}{\alpha})}}}^2,
