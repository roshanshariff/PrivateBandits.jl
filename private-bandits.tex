...
\subsection{Problem-Dependent Regret Bound}%
\label{sec:prob-dep-regret}

\todo[inline]{Move this to more appropriate place}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \widehat R_n &\le \frac{8B^2\bar\beta_n}{\Delta} d\log\frac{L^2b_t + \rho_{\min}}{\rho_{\min}}.
  \end{align*}
