...
unknown vector $\vec\theta^*\in\Real^d$. In fact, we simplify the problem statement to include the \emph{decision set}
...
\item The learner receives a stochastic \emph{reward}  $Y_t = \innerp{X_t}{\vec\theta^*} + \eta_t$.
\end{enumerate}
...
\begin{lemma}
  ...
  \begin{proof}
    ...
    \citep[Theorem~1]{AbbasiYadkoriImprovedAlgorithmsLinear2011}.  The
