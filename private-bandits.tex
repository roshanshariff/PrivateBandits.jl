...
\begin{assumptions*}[\Cref{alg:linucb}]{%
  ...
  $\abs{\innerp{\vec\theta^*}{\vec x}} \le B$ with $1\le B\le LS$.%
  \footnote{See \cref{remark:meanreward-bound} preceding the proof of
    ...
    the supplementary material for a discussion of this assumption and
    how $B$ affects the regret bound.} %
